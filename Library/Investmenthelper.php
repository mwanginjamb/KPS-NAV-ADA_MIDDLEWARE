...
class Investmenthelper extends Component{
    ...
    public function getData($service,$params=[]){
        ...
        $username = Yii::$app->params['INV_NavisionUsername'];
        $password = Yii::$app->params['INV_NavisionPassword'];

        $creds = (object)[];
        $creds->UserName = $username;
        $creds->PassWord = $password;

        $url = new InvestmentServices($service);
    ...
    public function readByKey($service,$Key){
        ...
        $url  =  new InvestmentServices($service);
        $wsdl = $url->getUrl();
        $username = (!Yii::$app->user->isGuest)? Yii::$app->user->identity->{'User ID'} : Yii::$app->params['INV_NavisionUsername'];
        $password = Yii::$app->session->has('IdentityPassword')? Yii::$app->session->get('IdentityPassword'):Yii::$app->params['INV_NavisionPassword'];
